...
Locked vertical-slice plans that authorize API work. They are not ADRs.
...
| Plan | Title | Status |
|------|-------|--------|
| [001](001-tenant-location-auth-context.md) | Tenant, location and authorization context | Locked (2026-08-16) |
